---
title: Go | Go标准 | Go推荐项目布局
description: 这是 Go 应用程序项目的基本布局。它不是核心 Go 开发团队定义的官方标准；然而，它是 Go 生态系统中一组常见的老项目和新项目的布局模式。其中一些模式比其他模式更受欢迎。它还具有许多小的增强，以及对任何足够大的实际应用程序通用的几个支持目录
slug: go/go_standard/project_layout
date: 2024-01-17
image: /pic/common/content/post/cover/042.jpg
categories:
  - Go
  - Reprint Article
tags:
...
**全文转载自 Standard Go Project Layout 的中文翻译**[https://github.com/golang-standards/project-layout/blob/master/README_zh.md](https://github.com/golang-standards/project-layout/blob/master/README_zh.md)
...
> - [1 ] Go 项目布局推荐 https://github.com/golang-standards/project-layout
